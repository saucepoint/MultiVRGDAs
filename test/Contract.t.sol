...
contract ContractTest is DSTestPlus {
    ...
    // A simple test to make sure the contract is not reverting
    // VRGDA math is verified by other tests
    // This test also helps sample gas usage for `forge test --gas-report`
